        ...
        <div className={styles.rightInner}>
          <div className={styles.couponHeading}>
            <Badge count={data ? data.length : 0} offset={[20, 10]}>
              <div className={styles.couponLeft}>Subcategories Parent</div>
            </Badge>
            <div className={styles.couponRight}>
              ...
              <Button
                type="primary"
                size="large"
                onClick={(e) => navigate("/admin/subcategory-parent/new")}
              >
                + Create New
              </Button>
            </div>
...
export default SubcategoriesParent;
