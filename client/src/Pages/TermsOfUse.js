  ...
  return (
    <>
      <div className="wrapAll">
        <h1 className="sign_h mt-5">Terms Of Use</h1>
        <hr className="line" />
        <div className="policies mb-5">
          <div className="row">
            <div className="col-lg-12 policies_container">
              <h6 className="policies_heading">1. Use of Platform</h6>
              <p className="policies_content">
            ...
            <div className="col-lg-12 policies_container">
              <h6 className="policies_heading">2. Privacy</h6>
              <p className="policies_content">
            ...
            <div className="col-lg-12 policies_container">
              <h6 className="policies_heading">3. Product Information</h6>
              <p className="policies_content">
            ...
            <div className="col-lg-12 policies_container">
              <h6 className="policies_heading">4. Pricing Information</h6>
              <p className="policies_content">
            ...
            <div className="col-lg-12 policies_container">
              <h6 className="policies_heading">5. Mode of Payment</h6>
              <p className="policies_content">
                For the products available on the site, either of the following
                modes of payment can be opted:
                <br />
                1. Credit cards, Debit cards, Net banking and Wallets
                <br />
                2. Cash on Delivery
              </p>
            </div>
            <div className="col-lg-12 policies_container">
              <h6 className="policies_heading">
            ...
            <div className="col-lg-12 policies_container">
              ...
              <p className="policies_content">
                ...
                shall be final.
                <br />
                For any disputes that arise related to orders outside India,
                international arbitration rules of Indian arbitration and
                conciliation act 1996 shall apply.
              </p>
            </div>
            <div className="col-lg-12 policies_container">
              <h6 className="policies_heading">8. Indemnification</h6>
              <p className="policies_content">
